...
const DesignerElementWrapper = ({
  ...
  const { removeElement, formId, setFormId, selectedElement, setSelectedElement } = useDesigner();
  ...
  return (
    // <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
      <div
        ...
        className="relative h-[140px] flex -flex-col text-foreground"
        onMouseEnter={(e) => {
          setMouseIsOver(true);
        }}
        onMouseLeave={(e) => {
      ...
      >
        ...
        <div
          className={cn(
            "flex w-full h-full items-center rounded-md bg-foreground/10 px-4 py-2 pointer-events-none opacity-100",
